...
ActiveRecord::Schema.define(:version => 20111214085731) do
  ...
  create_table "showroom_products", :force => true do |t|
  ...
  add_index "showroom_products", ["product_id"], :name => "index_showroom_products_on_product_id"
  add_index "showroom_products", ["showroom_id"], :name => "index_showroom_products_on_showroom_id"
  add_index "showroom_products", ["stylist_id"], :name => "index_showroom_products_on_stylist_id"
  ...
  add_index "showrooms", ["user_id"], :name => "index_showrooms_on_user_id"
